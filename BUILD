...
The following is a sample YAML file generated during this process:
   ...
   packages:
     - development:
       deb: /tmp/rmr-1.0.34.x86_64-dev-rotten.deb
       rpm: /tmp/rmr-1.0.34.x86_64-dev-rotten.rpm
     - runtime:
       deb: /tmp/rmr-1.0.34.x86_64-rotten.deb
       rpm: /tmp/rmr-1.0.34.x86_64-rotten.rpm
   ...
