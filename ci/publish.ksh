...
#				/tmp/build_packages.txt and copies the files to an export
#				directory.  The export directory is assumed to be mounted
#				from the outside world as /export, though we will use $1
