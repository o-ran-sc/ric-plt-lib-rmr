...
/*
	// ---------- coverage tests for receive specific ------------------------------------

	rmr_rcv_specific( NULL, NULL, "12345", 0 );
	...
	fprintf( stderr, "<INFO> invoking receive specific on context: %p\n", rmc );
	msg = rmr_rcv_specific( rmc, NULL, "12345", 1 );
*/
