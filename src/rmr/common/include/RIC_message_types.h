...
/*+
    ...
    These types are defined in the RIC_msg_types.h header file included with the RMR
    development package.
*/

/*+
    Non-Routable Types
    These types are not routable and a message passed to an RMR function with any of
	these types set will not be sent.
*/

#define RIC_UNDEFINED                       -1          //+ Mesage type is unset or undefined. Newly allocated messages
